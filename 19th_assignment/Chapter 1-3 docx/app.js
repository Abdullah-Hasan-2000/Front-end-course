...
alert("First Name: Abdullah");
alert("Last Name: Hasan");
alert("Email: abdullah.ah.hasan.2023@gmail.com");
alert("Phone Number: 0301-2183629");
alert("Password: None-Number");
